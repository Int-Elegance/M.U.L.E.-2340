 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jacob Zimmerman");
		  toPrint += p1.toString("902881009");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Marissa Wall");
		  toPrint += p2.toString("902813554");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Michael Maurer");
		  toPrint += p3.toString("902907227");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Lauren Winston");
          toPrint += p4.toString("902827482");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Joshua Long");
          toPrint += p5.toString("902876497");
